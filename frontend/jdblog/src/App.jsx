    ...
    <>
      <div className="flex flex-col xl:w-7xl w-5xl  text-stone-900 dark:text-stone-50">
        <div className="flex xl:flex-row flex-col-reverse max-w-dvw gap-16 xl:gap-0 ">
          ...
          <img
            src={profile}
            className="mt-22 mx-auto rounded-full max-w-[calc(80dvw)] max-h-[calc(80dvw)] h-96 w-96 border border-16 border-slate-500/50 shadow-[0_0px_10px_rgba(0,0,0,0.15)] sepia-50 "
          />
        </div>
